        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 mb-5">
                    ...
                    <form action="{{ route('store.courses') }}" method="post" id="login_form" class="p-5 bg-white">
                        @csrf
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="seats" name="seats" class="form-control" placeholder="">
                            </div>
                            ...
                            <div class="col-md-14">
                                ...
                                <input id="details" name="details"  class="form-control" placeholder="" />
                            </div>
                    <br>
