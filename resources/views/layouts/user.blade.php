...
<head>
    ...
    <title>E-Learn Center | User</title>
        ...
        <div class="nav-menu">
            <nav class="mainmenu mobile-menu">
                <ul>
                    ...
                    <li><a href="/userseminars">Attend Seminars</a>

                    </li>
                    <li><a href="usercourses">Join Courses</a>
                    <li><a href="/myapps">My Applications</a>
                    </li>
                    <li><a href="/userjobs">Job Portal</a>
